...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/ShinyLink)](https://cran.r-project.org/package=ShinyLink)
...
- Download link for RTools: https://cran.r-project.org/bin/windows/Rtools/
